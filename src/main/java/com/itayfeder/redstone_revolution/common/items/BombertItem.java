...
public class BombertItem extends Item {
    public BombertItem(Item.Properties builder) {
        super(builder);
    }
        ...
        if (direction == Direction.DOWN) {
            ...
            if (world.hasNoCollisions((Entity)null, axisalignedbb, (entity) -> {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    BombertEntity entity = EntityInit.BOMBERT.get().create(serverworld, itemstack.getTag(), (ITextComponent)null, context.getPlayer(), blockpos, SpawnReason.SPAWN_EGG, true, true);
                    if (entity == null) {
                        return ActionResultType.FAIL;
                    }
                    ...
                    entity.setTamedBy(context.getPlayer());
                    world.playSound((PlayerEntity)null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundEvents.ENTITY_ARMOR_STAND_PLACE, SoundCategory.BLOCKS, 0.75F, 0.8F);
                }
