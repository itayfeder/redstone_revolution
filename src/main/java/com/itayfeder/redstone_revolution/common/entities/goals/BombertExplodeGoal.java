package com.itayfeder.redstone_revolution.common.entities.goals;
...
public class BombertExplodeGoal extends Goal {
    ...
    public BombertExplodeGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
    ...
    protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
        ...
        if (distToEnemySqr <= d0 && this.field_234037_i_ <= 0) {
            this.func_234039_g_();
            attacker.world.createExplosion(attacker, attacker.getPosX(), attacker.getPosY(), attacker.getPosZ(), 1, Explosion.Mode.NONE);
